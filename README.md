...
![Dashboard Screenshot](https://raw.githubusercontent.com/SamtaSakha/Financial-Analysis-of-Healthcare-System/main/Screenshots/Financial_Analysis_of_HealthCare_System.png)
...
- Identify financial trends and inefficiencies
...
1. **Line Chart** – Financial Trend over Years  
   - Revenue vs Expense analysis

2. **Bar Chart** – Expense by Region  
   - Identifies high-cost regions

3. **Bar Chart** – Number of Patients by Department  
   - Shows patient load distribution

4. **Pie Chart** – Treatment Cost Distribution  
   - Highlights cost-intensive treatments
...
- Certain regions incur significantly higher expenses
...
- Improve financial efficiency in high-expense regions
